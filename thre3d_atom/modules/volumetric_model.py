...
class VolumetricModel:
    ...
    def render_rays(
        self, rays: Rays, sampled_points, parallel_points_chunk_size: Optional[int] = None, **kwargs
    ) -> RenderOut:
        """
        ...
        return self._render_procedure(
            self._thre3d_repr, rays, sampled_points, render_config, parallel_points_chunk_size
        )
